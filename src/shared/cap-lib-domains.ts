 ...
 *
 * ⚠️ 必须与 src/services/db.ts 的 CAP_LIB_DOMAIN_INIT 领域名保持一致（增删领域两处一起改）。
 *
 * approxCount 是 2026-06 抓取实测，会持续增长，仅作 UI 默认显示用，真实数量以同步后
 * cap_lib_meta.remote_total 为准。
 *
 * 移植自 bzxz src/shared/cap-lib-domains.ts。
 */
